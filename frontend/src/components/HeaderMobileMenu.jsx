...
const HeaderMobileMenu = ({ 
  ...
  return (
    <>
      ...
      <nav className="sm:hidden fixed bottom-0 left-0 right-0 z-50 h-[107px] bg-creamy px-[16px] pb-[40px] pt-[12px] shadow-[0_-2px_10px_rgba(0,0,0,0.05)] border-t border-choco-light/10">
